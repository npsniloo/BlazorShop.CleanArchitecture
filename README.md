...
![.NET 8/9](https://img.shields.io/badge/.NET-8.0/9.0-512bd4)
...
![Home Page](assets/screenshots/home-page.png)	![Shop Page](assets/screenshots/shop-page.png)	![Shopping Cart](assets/screenshots/shopping-cart.png)
🛠️ Tech Stack
...
Infrastructure: Persistence (EF Core), SQL Server implementation, and external services (Email).
WebUI: Blazor Server components and API endpoints.
🚧 Roadmap
...
💻 Getting Started
Clone the repository: `git clone https://github.com/YourUsername/BlazorShop.CleanArchitecture.git`
Update the connection string in `appsettings.json`.
Configure JWT settings (issuer, audience, and signing key) in `appsettings.json`.
Run `Update-Database` via Package Manager Console to initialize SQL Server.
